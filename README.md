...
- ` WEBFLASHER `INSTALLER FOR EASY UPLOAD CODE ON ESP32 NO NEED TO DOWNLOAD INO FILE (USE CHROME OR MICROSOFT BROWSER)
 ...
 [WEBFLASHER](https://flash.rujaltamrakar.com.np/flash1.html) HERE....SELECT WHAT TO UPLOAD `VSPI,HSPI OR DUAL` AND CHOOSE RIGHT `COM PORT`
...
* DOWLOAD CODE [INO FILE](https://github.com/rujal404/Ble-jammer/tree/master/INO)
